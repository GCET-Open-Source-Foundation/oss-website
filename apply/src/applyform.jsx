...
function ApplyForm() {
  ...
  const handleSubmit = (e) => {
    ...
    const subject = `OSS GCET Application - ${formData.fullName}`;
    const bodyLines = [
      ...
      `Year: ${formData.year}`,
      `Branch/Section: ${formData.branchSection}`,
      `Skills: ${formData.skills}`,
      `Why Join: ${formData.whyJoin}`,
      `Open Source Contribution: ${formData.contribution}`,
      `Preferred Role: ${formData.role}`,
      `Additional Info: ${formData.additional || "None"}`,
      "",
      "----",
      "This message was generated from the OSS GCET application form.",
    ];
    ...
    alert("A Gmail compose window will open with your application details. Please review and press SEND.");
    ...
    <>
      ...
      <div className="min-h-screen flex flex-col items-center px-4 py-10">
        <div className="max-w-2xl w-full bg-white rounded-xl">
          {/* Title */}
          <h1 className="text-2xl text-center mb-4">Apply to Join OSS GCET</h1>
          <p className="text-gray-600 text-center mb-8">
            Join our vibrant community of developers and innovators. We're
            looking for passionate students who want to contribute to open source
            projects and grow their technical skills together.
          </p>
